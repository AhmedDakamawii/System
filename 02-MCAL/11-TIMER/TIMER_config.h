...
#define MTIM4_STATUS                  OFF //off to be used in cruise control

#if MTIM2_STATUS         ==           ON
/*
 * Enter Value (1 -> 65536)
 */
#define MTIM2_PRESCALER               100
...
#define MTIM2_PWM_CHANNEL2_STATUS     OFF
#define MTIM2_PWM_CHANNEL3_STATUS     OFF
#define MTIM2_PWM_CHANNEL4_STATUS     OFF

/* Needed Working Frequency for PWM */
#define MTIM2_PWM_FREQ                1000
...
#define MTIM3_PWM_CHANNEL2_STATUS     OFF
#define MTIM3_PWM_CHANNEL3_STATUS     OFF
 ...
 *         CHANNEL4  B9
 */
#define MTIM4_PWM_CHANNEL1_STATUS     ON
